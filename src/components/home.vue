...
<div id='home'>
  ...
  <mt-swipe-item v-for='item in lunbolist':key='item.url'><img :src='item.url'></mt-swipe-item>
	</mt-swipe>
...
export default {
	...
	methods:{
	  ...
	  //    this.$http.get('https://www.apiopen.top/meituApi?page=1').then(function(data){
